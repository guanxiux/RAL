...
def make_table(rows: list[dict]) -> str:
    ...
    lines = [
        ...
        r"  on RTX~3080. The $\eta$ values are averaged over layers and frames;",
        r"  $n_{\mathcal{W}}$ percentiles are taken over all layer--frame samples.}",
        ...
        r"  and DynConv on RTX 3080. Eta values are averaged over layers and frames;",
        r"  worklist-length statistics use all layer-frame samples.}",
