\begin{table}[!t]
  ...
  on RTX~3080. The $\eta$ values are averaged over layers and frames;
  $n_{\mathcal{W}}$ percentiles are taken over all layer--frame samples.}
  ...
  and DynConv on RTX 3080. Eta values are averaged over layers and frames;
  worklist-length statistics use all layer-frame samples.}
