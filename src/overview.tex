...
\begin{figure*}[t]
  ...
  the metadata across compatible operators. Compute bounds
  persistent work on the device and adapts its decomposition from a completed,
  temporally lagged input-activity observation without host synchronization.}
