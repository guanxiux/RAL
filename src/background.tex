...
grid $\mathcal{G}=\{1,\ldots,H_{out}W_{out}\}$, where each coordinate $p\in\mathcal{G}$ has a
...
extreme $\mathcal{C}=\mathcal{G}$. The policy fixes the accuracy and the
required work, while $\mathcal{C}$ is determined by the path.
